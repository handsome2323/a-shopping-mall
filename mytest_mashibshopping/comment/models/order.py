...
class Order(db.Model):
    ...
    order_status = db.Column(db.Integer, default=0, nullable=False, comment='订单状态：0->待付款；1->待发货；2->待收货；3->交易完成；4->已取消；5->超时取消:6->无效订单')
...
class OrderItem(db.Model):
    ...
    product_attr = db.Column(db.String, comment='实例：商品销售属性:[{"key":"颜色","value":"颜色"},{"key":"容量","value":"4G"}]')
